import { AssemblyFragment, OperatorFormattor, ParseFragment } from '../assembler-lib';
import { Minisys32OperatorRepository } from './schema/minisys-32-operator.repository';
